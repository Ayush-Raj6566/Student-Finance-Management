...
const ChatBot: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const botMessage = {
        ...
        text: response.data?.final_answer || "I'm here to help with your finance questions! Could you please rephrase your question?",
        isBot: true,
        timestamp: new Date()
      };
  ...
  const suggestedQuestions = [
    "How much I spent on food this month?",
    "How much I spent on shopping this month?",
    "How much I spent on entertainment this month",
    "How much I spent on health this month"
  ];
